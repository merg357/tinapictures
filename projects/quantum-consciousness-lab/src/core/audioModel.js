...
function normalizeAudioSettings(input = {}) {
  return {
    ...
    narrationSpeed: Math.max(0.5, Math.min(1.5, Number.isFinite(Number(input.narrationSpeed)) ? Math.round(Number(input.narrationSpeed) * 20) / 20 : DEFAULT_AUDIO_SETTINGS.narrationSpeed)),
